...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        backup_root = Path(options['output_dir']).resolve() / f'guest258-backup-{timestamp}'
        ...
        if media_root.exists():
            ...
            if options['include_media'] and getattr(settings, 'GUEST258_STORAGE_BACKEND', 'local') == 'local':
